...
public class ServiceManager extends AbstractManager implements IServiceManager {
    ...
    @Override
    public M3Result<Map<String, Object>> activateManagement(IPrincipal principal, IServiceRequest request) {
        return execute(principal, request, new TypeReference<>() {});
    }

    @Override
    public M3Result<Map<String, Object>> deactivateManagement(IPrincipal principal, IServiceRequest request) {
        return execute(principal, request, new TypeReference<>() {});
    }

    @Override
    public M3Result<Map<String, Object>> activateBudget(IPrincipal principal, IServiceRequest request) {
        return execute(principal, request, new TypeReference<>() {});
    }

    @Override
    public M3Result<Map<String, Object>> deactivateBudget(IPrincipal principal, IServiceRequest request) {
        return execute(principal, request, new TypeReference<>() {});
    }

    @Override
    public M3Result<Map<String, Object>> describeCustodianLicenses(IPrincipal principal, IServiceRequest request) {
        return execute(principal, request, new TypeReference<>() {});
    }
