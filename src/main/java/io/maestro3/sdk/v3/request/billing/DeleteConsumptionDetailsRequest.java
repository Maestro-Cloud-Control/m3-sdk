...
public class DeleteConsumptionDetailsRequest extends AbstractConsumptionRequest {
    ...
    public static DeleteConsumptionDetailsRequestBuilder builder() {
        return new DeleteConsumptionDetailsRequestBuilder();
    }

    @Override
    public ActionType getActionType() {
        return ActionType.DELETE_CONSUMPTION_DETAILS;
    }
