...
@JsonDeserialize(builder = DescribeResourceRequest.Builder.class)
public class DescribeResourceRequest implements IRegionRequest {

    private final String tenantName;
    private final String region;
    private final String resourceId;

    public DescribeResourceRequest(Builder builder) {
    ...
    public ActionType getActionType() {
        return ActionType.DESCRIBE_RESOURCE;
    }
