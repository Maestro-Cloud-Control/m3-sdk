...
@JsonDeserialize(builder = UpdateDashboardActionRequest.Builder.class)
public class UpdateDashboardActionRequest implements IRequest {
    ...
    private UpdateDashboardActionRequest(Builder builder) {
    ...
    public ActionType getActionType() {
        return ActionType.UPDATE_USER_SPECIFIC_DASHBOARD_ACTION;
    }
    ...
    public static final class Builder {
        ...
        public UpdateDashboardActionRequest build() {
            return new UpdateDashboardActionRequest(this);
        }
    }
}
