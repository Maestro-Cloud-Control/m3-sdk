...
@JsonDeserialize(builder = DeleteScheduleRequest.Builder.class)
public class DeleteScheduleRequest implements IRegionRequest {
    ...
    public ActionType getActionType() {
        return ActionType.DELETE_SCHEDULE;
    }
