...
@JsonDeserialize(builder = ProlongTerraformTemplateLockRequest.Builder.class)
public class ProlongTerraformTemplateLockRequest implements ITenantRequest {
    ...
    public ActionType getActionType() {
        return ActionType.PROLONG_TERRAFORM_TEMPLATE_LOCK;
    }
