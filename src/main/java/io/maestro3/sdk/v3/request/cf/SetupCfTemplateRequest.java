...
@JsonDeserialize(builder = SetupCfTemplateRequest.Builder.class)
public class SetupCfTemplateRequest implements ITenantRequest {
    ...
    private SetupCfTemplateRequest(Builder builder) {
    ...
    public ActionType getActionType() {
        return ActionType.SETUP_CF_TEMPLATE;
    }
    ...
    public static final class Builder {
        ...
        public SetupCfTemplateRequest build() {
            Assert.hasText(this.tenantName, "tenantName");
            Assert.hasText(this.templateName, "templateName");
            Assert.hasText(this.templateContent, "templateContent");
            return new SetupCfTemplateRequest(this);
        }
