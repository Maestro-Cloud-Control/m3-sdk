...
@JsonDeserialize(builder = FinishOwnershipByResourceIdRequest.Builder.class)
public class FinishOwnershipByResourceIdRequest implements IResourceRequest {

    private final ResourceIdRequest resourceIdRequest;

    private FinishOwnershipByResourceIdRequest(Builder builder) {
    ...
    public ActionType getActionType() {
        return ActionType.FINISH_OWNERSHIP;
    }
    ...
    public static final class Builder {
        ...
        public FinishOwnershipByResourceIdRequest build() {
            // assert not null (sdk usages with empty string)
            Assert.notNull(resourceIdRequest, "resourceIdRequest");
            return new FinishOwnershipByResourceIdRequest(this);
        }
    }
}
