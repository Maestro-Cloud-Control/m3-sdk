...
@JsonDeserialize(builder = ResolveSupportCaseRequest.Builder.class)
public class ResolveSupportCaseRequest extends AbstractSupportRequest {
    private final String id;
    private final String comment;
    private final List<SdkSupportCaseAttachment> attachments;

    private ResolveSupportCaseRequest(Builder builder) {
        super(builder);
        this.id = builder.id;
    ...
    public ActionType getActionType() {
        return ActionType.RESOLVE_SUPPORT_REQUEST;
    }
    ...
    public static final class Builder
            extends AbstractSupportRequestBuilder<Builder, ResolveSupportCaseRequest> {
        ...
        public ResolveSupportCaseRequest build() {
            Assert.hasText(id, "id");
            if (SdkSupportProvider.AWS == this.supportProvider) {
                Assert.hasText(comment, "comment");
            }
            return new ResolveSupportCaseRequest(this);
        }
    }
}
