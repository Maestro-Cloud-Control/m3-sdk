...
@JsonDeserialize(builder = ResourceCreatorByResourceIdRequest.Builder.class)
public class ResourceCreatorByResourceIdRequest implements IResourceRequest {

    private final ResourceIdRequest resourceIdRequest;

    private ResourceCreatorByResourceIdRequest(Builder builder) {
    ...
    public static final class Builder {
        ...
        public ResourceCreatorByResourceIdRequest build() {
            Assert.notNull(resourceIdRequest, "resourceIdRequest");
            return new ResourceCreatorByResourceIdRequest(this);
        }
    }
}
