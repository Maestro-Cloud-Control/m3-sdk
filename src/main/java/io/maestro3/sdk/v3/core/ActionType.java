...
public enum ActionType {
    ...
    GET_RADAR_DASHBOARD_ACTION,
    GET_CUSTOM_METRICS,
    GET_GRAPH_IMAGE,
    GENERATE_GRAPH_URLS,
    GET_CUSTOM_METRIC_VALUE,
    GET_RADAR_CUSTOMER_LEVEL,
    ...
    GET_DEPLETED_ACTIVE_USER_QUOTAS,
    ...
    DEACTIVATE_BILLING,
    ACTIVATE_MANAGEMENT,
    DEACTIVATE_MANAGEMENT,
    DESCRIBE_CUSTODIAN_LICENSES,
    ACTIVATE_CUSTODIAN,
    ...
    ACTIVATE_BUDGET,
    DEACTIVATE_BUDGET,
    ACTIVATE_NATIVE_BUDGET,
    DEACTIVATE_NATIVE_BUDGET,
    ...
    //CLOUD FORMATION
    DESCRIBE_CF_TEMPLATE,
    DESCRIBE_CF_TEMPLATE_BY_FILTERS,
    SETUP_CF_TEMPLATE,
    DELETE_CF_TEMPLATES,
    CREATE_CF_STACK,
    DESCRIBE_CF_STACK,
    ...
    EXECUTE_TENANT_CONTACT_CONFIRMATION_APPROVAL_ACTION,
    ...
    DESCRIBE_PLATFORM_SERVICE_ENTRY_SECRETS,
    ...
    DESCRIBE_KUBERNETES_CLUSTER_INSTANCES,
    GET_KUBERNETES_AUTHENTICATION_TOKEN,
    ...
    DESCRIBE_KUBERNETES_CLUSTER_AUTO_SCALING_GROUPS,
    CHANGE_AUTO_SCALING_GROUP_SIZE,
    ;
