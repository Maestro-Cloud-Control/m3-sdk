...
public class BasicTableViewWithDataset<R extends ITableRecord> extends BasicTableView<R> {

    private List<Object> additionalDataset;

    protected BasicTableViewWithDataset() {
    }

    public BasicTableViewWithDataset(List<String> headers,
                                     List<R> records,
                                     TableViewConfig viewConfig,
                                     List<Object> additionalDataset) {
        super(ITableModel.BASIC_TABLE_WITH_DATASET, headers, records, viewConfig);
        this.additionalDataset = additionalDataset;
    }

    @JsonCreator
    protected BasicTableViewWithDataset(@JsonProperty("type") String type,
        ...
        super(type, headers, records, viewConfig);
        this.additionalDataset = additionalDataset;
    }
