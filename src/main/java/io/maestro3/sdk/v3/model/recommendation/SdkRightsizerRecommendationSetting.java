...
public class SdkRightsizerRecommendationSetting extends SdkRecommendationSetting {

    private SdkRecommendationCategory category;

    public SdkRightsizerRecommendationSetting() {
        this.setSource(SdkUiRecommendationSource.RIGHTSIZER);
    }
