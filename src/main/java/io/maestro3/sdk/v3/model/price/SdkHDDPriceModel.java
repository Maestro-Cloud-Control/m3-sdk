...
public abstract class SdkHDDPriceModel {

    private BigDecimal inactivePrice;
    private BigDecimal activePrice;

    public BigDecimal getInactivePrice() {
        return inactivePrice;
    }

    public void setInactivePrice(BigDecimal inactivePrice) {
