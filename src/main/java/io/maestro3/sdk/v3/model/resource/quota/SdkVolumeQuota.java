...
public class SdkVolumeQuota implements IVolumeQuota {

    private int maxSize = DefaultValues.MAX_SIZE;
    ...
    public SdkVolumeQuota() {
        //json
    }

    public SdkVolumeQuota(IVolumeQuota clone) {
        this.maxSize = clone.getMaxSize();
    ...
    public static SdkVolumeQuota defaultVolumeQuota() {
        SdkVolumeQuota quota = new SdkVolumeQuota();
        quota.setMaxSize(DefaultValues.MAX_SIZE);
        quota.setCreationIntervalHours(DefaultValues.CREATION_INTERVAL_HOURS);
        quota.setCreationIntervalCount(DefaultValues.CREATION_INTERVAL_COUNT);
        return quota;
    }
}
